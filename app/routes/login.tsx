  ...
  return (
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden bg-background">
      ...
      <div 
        ...
        style={{
          backgroundImage: 'url(https://images.pexels.com/photos/239975/pexels-photo-239975.jpeg)',
      ...
      {/* Gradient overlay */}
      <div className="absolute inset-0 z-0 bg-gradient-to-br from-primary/30 via-background/80 to-background" />
